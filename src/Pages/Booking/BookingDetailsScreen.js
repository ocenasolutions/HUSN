// src/Pages/USER/BookingDetailsScreen.js - Enhanced with OTP display
          ...
          {booking.status === 'in_progress' && booking.otpVerifiedAt && (
            <View style={styles.progressCard}>
              ...
              <Text style={styles.progressText}>
                Service started at {new Date(booking.serviceStartedAt).toLocaleTimeString('en-US', {
                  hour: '2-digit',
                  minute: '2-digit'
                })}
              </Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoCard}>
            ...
            <View style={styles.detailRow}>
              ...
              <Text style={[styles.detailValue, { color: booking.paymentStatus === 'completed' ? '#27AE60' : '#F39C12' }]}>
          ...
          <View style={styles.timelineCard}>
            ...
            {booking.serviceStartedAt && (
              <View style={styles.timelineItem}>
                ...
                <Text style={styles.timelineText}>
                  Service started on {formatDate(booking.serviceStartedAt)}
                </Text>
              </View>
            )}
            {booking.completedAt && (
